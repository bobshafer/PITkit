...
Since this 'History' was written, things have kept progressing. As of
this writing (Nov 18, 2025), PIT is a very viable scientific theory, and
the implications of the theory are being looked through for opportunities
to demonstrate PIT, either by providing an alternative explanation for already-
known things, and also there are a number of very clear predictions that PIT
makes that can be verified (or not).
